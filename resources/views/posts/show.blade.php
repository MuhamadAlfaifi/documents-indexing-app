  ...
  <div class="md:grid md:grid-cols-3 mt-10 md:gap-6 border-2 border-red-500 rounded-lg m-8">
    <div class="md:col-span-1">
      <div class="p-3">
        ...
        <p class="mt-1 text-sm text-gray-600">لا يمكن التراجع عن الملفات المحذوفة</p>
        <form class="inline-block mt-4" action="{{ route('posts.destroy', ['post' => $post->id]) }}" method="POST" onsubmit="return confirm('حذف الملف؟')">
          @csrf()
          @method('delete')
