<div class="bg-white">
  ...
  <section aria-labelledby="filter-heading" class="relative z-10 border-t border-b border-gray-200 grid items-center">
    <h2 id="filter-heading" class="sr-only">خيارات البحث</h2>
    <div class="relative col-start-1 row-start-1 py-4">
      <div class="max-w-7xl mx-auto flex space-x-reverse space-x-6 divide-x divide-x-reverse divide-gray-200 text-sm px-4 sm:px-6 lg:px-8">
        <div>
          <button type="button" class="group text-gray-700 font-medium flex items-center" aria-controls="disclosure-1" aria-expanded="false">
            ...
            <svg class="flex-none w-5 h-5 ml-2 text-gray-400 group-hover:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          ...
          <fieldset>
            ...
            <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="price-0" class="mr-3 min-w-0 flex-1 text-gray-600"> $0 - $25 </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="price-1" class="mr-3 min-w-0 flex-1 text-gray-600"> $25 - $50 </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="price-2" class="mr-3 min-w-0 flex-1 text-gray-600"> $50 - $75 </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="price-3" class="mr-3 min-w-0 flex-1 text-gray-600"> $75+ </label>
              </div>
            </div>
          </fieldset>
          <fieldset>
            ...
            <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="color-0" class="mr-3 min-w-0 flex-1 text-gray-600"> White </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="color-1" class="mr-3 min-w-0 flex-1 text-gray-600"> Beige </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="color-2" class="mr-3 min-w-0 flex-1 text-gray-600"> Blue </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="color-3" class="mr-3 min-w-0 flex-1 text-gray-600"> Brown </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="color-4" class="mr-3 min-w-0 flex-1 text-gray-600"> Green </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="color-5" class="mr-3 min-w-0 flex-1 text-gray-600"> Purple </label>
              </div>
            </div>
          </fieldset>
        </div>
          ...
          <fieldset>
            ...
            <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="size-0" class="mr-3 min-w-0 flex-1 text-gray-600"> XS </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="size-1" class="mr-3 min-w-0 flex-1 text-gray-600"> S </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="size-2" class="mr-3 min-w-0 flex-1 text-gray-600"> M </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="size-3" class="mr-3 min-w-0 flex-1 text-gray-600"> L </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="size-4" class="mr-3 min-w-0 flex-1 text-gray-600"> XL </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="size-5" class="mr-3 min-w-0 flex-1 text-gray-600"> 2XL </label>
              </div>
            </div>
          </fieldset>
          <fieldset>
            ...
            <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="category-0" class="mr-3 min-w-0 flex-1 text-gray-600"> All New Arrivals </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="category-1" class="mr-3 min-w-0 flex-1 text-gray-600"> Tees </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="category-2" class="mr-3 min-w-0 flex-1 text-gray-600"> Objects </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="category-3" class="mr-3 min-w-0 flex-1 text-gray-600"> Sweatshirts </label>
              </div>
              ...
              <div class="flex items-center text-base sm:text-sm">
                ...
                <label for="category-4" class="mr-3 min-w-0 flex-1 text-gray-600"> Pants &amp; Shorts </label>
              </div>
            </div>
          </fieldset>
        </div>
