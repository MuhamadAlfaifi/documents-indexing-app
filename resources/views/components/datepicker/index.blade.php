  ...
  <div class="container">
    <div class="w-64">
      <div class="relative h-6">
        <input type="hidden" name="{{ $name }}" onchange="event.target.form.submit()" x-ref="date" :value="datepickerValue" />
        <input type="text" x-on:click="showDatepicker = !showDatepicker" x-model="datepickerValue"
          x-on:keydown.escape="showDatepicker = false"
          class="w-full leading-none rounded-lg shadow-sm block h-full border-0 border-b border-transparent bg-gray-100 focus:border-indigo-600 focus:ring-0 sm:text-sm"
        ...
        <div class="bg-white mt-10 rounded-lg shadow p-4 absolute top-0 right-0" style="width: 17rem"
          x-show.transition="showDatepicker" @click.away="showDatepicker = false">
          <div class="flex justify-between items-center mb-2">
            <div>
              <span x-text="MONTH_NAMES[month]" class="text-lg font-bold text-gray-800"></span>
              <span x-text="year" class="mr-1 text-lg text-gray-600 font-normal"></span>
            </div>
            <div>
              <button type="button"
